 ...
 */
package org.giftwrapping.cockpits.setup;
...
import org.giftwrapping.cockpits.constants.GiftwrappingCockpitsConstants;
 ...
 */
@SystemSetup(extension = GiftwrappingCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(GiftwrappingCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(GiftwrappingCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						GiftwrappingCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/giftwrappingcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
