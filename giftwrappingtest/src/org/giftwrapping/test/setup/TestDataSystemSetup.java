 ...
 */
package org.giftwrapping.test.setup;
...
import org.giftwrapping.test.constants.GiftwrappingTestConstants;
import org.giftwrapping.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = GiftwrappingTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/giftwrappingtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/giftwrappingtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/giftwrappingtest/import/cstickets.impex");
			...
			importImpexFile(context, "/giftwrappingtest/import/csquotes.impex");
		}
	}
}
